...
/**
 * OutputHeatmap
 * Mini heatmap visualization for the output neuron
 * Shows the final network output across the coordinate space
 */
...
export function OutputHeatmap({ size = 30 }: OutputHeatmapProps) {
  ...
  const drawHeatmap = useCallback(() => {
    ...
    // Sample the network output at each grid point
